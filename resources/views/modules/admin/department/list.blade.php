                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel33">Add New Department</h4>
                        ...
                        <form class="add_category">
                            ...
                            <div class="modal-body row gy-1 gx-2 mt-75">
                                ...
                                <div class="mb-1 col-12">
                                    ...
                                    <input type="text" name="name" placeholder="web & App" class="form-control name" />
                                </div>
                            ...
                            <table class="datatables-basic table">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($departments as $department)
                                        <tr>
                                            <td><?= $department->id ?></td>
                                            <td class="cat_name"><?= $department->name ?></td>
                                            <td>

                                                <a href="#!" class="item-edit" data-id="<?= $department->id ?>"  data-bs-toggle= "modal" data-bs-target= "#inlineForm" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit value Detail">
                                                    <i data-feather='edit'></i>
                                                </a>

                                                <a href="#!" class="delete-record" data-id="<?= $department->id ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Delete value">
